...
#! 24.1
#|
The file 'grades' was created to load the initial state of the desired spreadsheet.
To load it...

(spreadsheet) ;; This will load the spreadsheet program
?? (load "grades") ;; In the console, enter this command
...
(put 74 d5)
(put 'Avg e1)
(put (/ (+ (cell b) (cell c) (cell d)) 3) e)



    -----a----  -----b----  -----c----  -----d----  -----e----  -----f----
 1 >NAME      < Assign1     Assign2     Assign3     Avg                    
 2  Paul             71.00       71.00       71.00       71.00             
 3  John             72.00       72.00       72.00       72.00             
 4  George           73.00       73.00       73.00       73.00             
